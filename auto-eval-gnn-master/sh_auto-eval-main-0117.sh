...
--model_path './logs/acm-to-dblp-GAT-full-0-0-20230117-155857-034722' \
--aug_data_path './logs/Meta-save-acm-num-300-0-20230117-162906-177221'
# --> get load_path
#./logs/Meta-feat-acc-acm-GAT-num-300-0-20230117-175809-721176

# step 4
CUDA_VISIBLE_DEVICES=1 python meta_regression_nn.py --seed=0 \
	--source acm --target dblp --model GAT --hid_dim 128 --encoder_dim 16 --val_num 30 --reg_model 'mlp_simple'\
	--k_laplacian 5 --epochs_reg 200 --lr_reg 0.1 --dropout_reg 0 \
	--model_path './logs/acm-to-dblp-GAT-full-0-0-20230117-155857-034722' \
	--load_path './logs/Meta-feat-acc-acm-GAT-num-300-0-20230117-175809-721176'
# --> get our 'super model' which is trained based on the original given model
#./logs/metaLR-acm-to-dblp-GAT-0-20230119-084756-613035
...
CUDA_VISIBLE_DEVICES=1 python meta_regression_nn.py --seed=0 \
	...
	--load_path './logs/Meta-feat-acc-acm-GAT-num-300-0-20230117-175809-721176'
# --> get our 'super model' which is trained based on the original given model
#./logs/metaLR-acm-to-dblp-GAT-0-20230119-085903-270711
"
