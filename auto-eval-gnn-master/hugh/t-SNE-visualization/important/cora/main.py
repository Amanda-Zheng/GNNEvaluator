...
def is_cora_0_5(path):
    return path.find('cora_0.5') != -1


def is_cora_1_0(path):
    return path.find('cora_1.0') != -1


def is_cora_0_25(path):
    return path.find('cora_0.25') != -1
